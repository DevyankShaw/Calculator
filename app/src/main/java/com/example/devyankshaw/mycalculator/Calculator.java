package com.example.devyankshaw.mycalculator;
            ...
            if (currentNumber != "") {
                ...
                switch (currentOperator) {
                    ...
                    case MULTIPLY:
                        ...
                        break;
                    case DIVIDE:
                        if(Integer.parseInt(stringNumberAtLeft) != 0 && Integer.parseInt(stringNumberAtRight) == 0){
